...
const Boats = ({ consultaCliente, añadirCliente, editarCliente, eliminarCliente, arreglo }) => {
    //useStyles
    ...
    return (
        <>
            <Dialog
                ...
                fullWidth={true}
            >
                <DialogTitle className={classes.tituloModalEliminarClient}>
                    Eliminar Cliente
                </DialogTitle>
                <IconButton
                    ...
                    <Grid container justify="center" alignItems="center">
                        <Grid item md={12} sm={12} xs={12} className="text-center mb-3" style={{ textAlign: 'center' }}>
                            <Typography
                                ...
                                variant="h6"
                            >
                                ¿ Esta seguro que desea eliminar al cliente {data.name} ?
                            </Typography>
                        </Grid>
                    </Grid>
                </DialogContent>
            ...
            <Grid container component={Paper} style={{ borderRadius: '25px', padding: '20px', }} display="flex" justifyContent="center" alignItems="center">
                <Grid item md={12} xs={12} sm={12} className="text-center" style={{ textAlign: 'center' }}>
                    <Box mt={2} style={{ boxShadow: 'none' }}>
                        <Card className={classes.media} style={{ boxShadow: 'none' }}>
                            <CardHeader
                                className={classes.textCardClient}
                                title="Cliente"
                            />
                        </Card>
                    </Box>
                ...
                <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                    <SpeedDial
                        ...
                        icon={
                            <AppRegistrationIcon
                                className={classes.logoSpeedDialClient}
                            />
                        }
                        open={open}
                    >
