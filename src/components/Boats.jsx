...
const Boats = ({ consultaBote, añadirBote, editarBote, eliminarBote, arreglo, arregloCategoria, consultaCategoria }) => {
    //useStyles
    ...
    return (
        <>
            <Dialog
                ...
                fullWidth={true}
            >
                <DialogTitle className={classes.tituloModalEliminarBote}>
                    Eliminar Bote
                </DialogTitle>
                <IconButton
                    ...
                    <Grid container justify="center" alignItems="center">
                        <Grid item md={12} sm={12} xs={12} className="text-center mb-3" style={{ textAlign: 'center' }}>
                            <Typography
                                ...
                                variant="h6"
                            >
                                ¿ Esta seguro que desea eliminar el bote {data.name} ?
                            </Typography>
                        </Grid>
                    </Grid>
                </DialogContent>
            ...
            <Grid container component={Paper} style={{ borderRadius: '25px', padding: '20px', }} display="flex" justifyContent="center" alignItems="center">
                <Grid item md={12} xs={12} sm={12} className="text-center" style={{ textAlign: 'center' }}>
                    <Box mt={2} style={{ boxShadow: 'none' }}>
                        <Card className={classes.media} style={{ boxShadow: 'none' }}>
                            <CardHeader
                                className={classes.textCardBote}
                                title="Botes"
                            />
                        </Card>
                    </Box>
                ...
                <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                    <SpeedDial
                        ...
                        icon={
                            <AppRegistrationIcon
                                className={classes.logoSpeedDialBote}
                            />
                        }
                        open={open}
                    >
                                                ...
                                                <TableRow
                                                    ...
                                                    onClick={() => {
                                                        if (editMode) {
                                                            ...
                                                            setSelectCategory(item.category.id)
                                                            openModal()
                                                        }
                                                        if (botonEliminar) {
                                                            setData(item)
